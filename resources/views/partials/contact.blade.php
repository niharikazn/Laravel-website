            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mu-contact-left">
                  <form class="contactform" action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf  
                  <p class="comment-form-author">
                    ...
                    <p class="comment-form-url">
                      ...
                      <input type="text" required="required" aria-required="true" name="subject">
                    </p>
